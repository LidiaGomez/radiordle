  ...
  return (
    ...
    >
      <p className="text-sm text-gray-500 dark:text-gray-300">
        ...
        Happy Valentine's Day, my love, you deserve way more than Radiordle but
        I only show love in Computer.
      </p>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300">For</p>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300">Always.</p>
    </BaseModal>
  )
}
